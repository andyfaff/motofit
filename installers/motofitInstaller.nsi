...
InstallDir "$PROGRAMFILES/Wavemetrics/Igor Pro Folder"
InstallDirRegKey HKEY_LOCAL_MACHINE "SOFTWARE/Microsoft/Windows/CurrentVersion/App Paths/Igor.exe" "Path"
