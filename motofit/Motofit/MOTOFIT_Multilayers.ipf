...
Function Setupmultilayer(ctrlname,checked) : CheckboxControl
	...
	switch(checked)	
		...
		case 1:		
			...
			NVAR Vmullayers=root:packages:motofit:reflectivity:tempwaves:Vmullayers
			NVAR Vmulrep= root:packages:motofit:reflectivity:tempwaves:Vmulrep
			NVAR Vappendlayer=root:packages:motofit:reflectivity:tempwaves:Vappendlayer
...
//this will take coef_multiCref and turn it back into coef_Cref and Multilay
