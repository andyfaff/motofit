...
Function plotCalcref()
	...
	if(!itemsinlist(winlist("reflectivitygraph", ";", "WIN:1")))
		...
		Label left "\\F'Symbol'r\\F'Arial' /10\\S-6\\M A\\S-2 "
...
Function Moto_Reflectivitypanel() : Panel
	...
	ListBox baseparams,pos={92,52},size={146,153},proc=moto_modelchange,frame=0, fsize=12
...
Function Moto_SLD_at_depth(w, zed)
	...
	Variable deltarho,sigma,thick,dist
